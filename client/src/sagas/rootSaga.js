...
import {privateSaga, updateUserData, notAuthorizeSaga, headerRequest, getUserTransactionsSaga} from './userSaga';
...
function* rootSaga() {
    ...
    yield  takeEvery(ACTION.GET_USER_TRANSACTIONS_ACTION, getUserTransactionsSaga);
